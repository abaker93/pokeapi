export default function Pokeball(props) {
	...
	return (
		<>
			...
			<g id="Pokéball_1_">
				<g id="Colours">
					<path style={{ fill: white }} id="Down" d="M297.6,380.9c-40.4,0-74.1-28.6-82.1-66.6H81.1c9.5,110.5,102.2,197.2,215.1,197.2 s205.7-86.7,215.1-197.2H379.7C371.7,352.4,338,380.9,297.6,380.9z"/>
					<path style={{ opacity: shadowOpacity }} id="Shadow_Down" className="st1" d="M345.6,505.9c89.6-21,157.7-97.7,165.7-191.6h-53C453,399.5,408.3,471.7,345.6,505.9z"/>
					<path style={{ fill: white }} id="Center" className="st0" d="M347.1,297L347.1,297C347,297,347,297,347.1,297c-0.1-6.1-1.2-11.9-3.2-17.3
					...
					<path style={{ fill: primaryColor }} id="Up" className="st2" d="M297.7,213.2c40.4,0,74.1,28.6,82.1,66.6h134.4C504.7,169.2,412,82.5,299,82.5S93.4,169.2,83.9,279.7
						h131.7C223.6,241.7,257.3,213.2,297.7,213.2z"/>
					<path style={{ opacity: shadowOpacity }} id="Shadow_Up" className="st3" d="M458.3,279.7h55.8c-8.2-95.5-78.6-173.3-170.5-192.6C407.4,120.8,452.9,193.7,458.3,279.7z"/>
				</g>
